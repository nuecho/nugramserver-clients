...
/*
 * This code was found on http://stackoverflow.com/questions/917604/decode-base64-string-java-5
 */
public class Base64
{
    ...
    public String encode(byte[] bin, int str, int len)
    {
        ...
        if (ol != sb.length())
        {
            throw new RuntimeException("Error in Base64 encoding method: Calculated output length of "
                                       + ol
